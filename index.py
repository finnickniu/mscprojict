...
def loaddata(i, times, result,total):
    ...
    if c < 10:
        c = str('0' + str(c))
    data12 = pd.read_csv(path+'alldata3.csv')
    ...
    pd.DataFrame(data18).to_csv(path+'test.csv', index=None)
    #
    #
    # #process data
...
def fit_lstm(train, test, dataset, scaler, batch_size, epochs, neurons,date,class1,raw1,result, outlierdate):
    ...
    dataframe = pd.read_csv(path+"lstmvalidation2.csv")
...
def lstmmatches():
    if request.method=='POST':
        ...
        pyplot.savefig(pathproject+'static/epochs_diagnostic1.png')
...
def lstmconcat():
    nove2012 = pd.read_csv(path+"/trafficdata/20121101.csv")
    nove2013 = pd.read_csv(path+"/trafficdata/20131101.csv")
    nove2015 = pd.read_csv(path+"/trafficdata/20151101.csv")
    nove2016 = pd.read_csv(path+"/trafficdata/20161101.csv")
    ...
    dec2012 = pd.read_csv(path+"/trafficdata/20121201.csv")
    dec2013 = pd.read_csv(path+"/trafficdata/20131201.csv")
    dec2015 = pd.read_csv(path+"/trafficdata/20151201.csv")
    dec2016 = pd.read_csv(path+"/trafficdata/20161201.csv")
...
def Kmeans(count,outliers,q,w,points4,total):
    ...
    allmatch = pd.read_csv(path + 'allmatches.csv', encoding='utf-8', index_col='Sdate', date_parser=dateparse)
    allnove3 = pd.read_csv(path+ 'alldata3.csv', encoding='utf-8', index_col='Sdate', date_parser=dateparse1)
    ...
    #
    pd.DataFrame(label).to_csv(path+'labels.csv', header=['class'], index=None)
    data44 = pd.read_csv(path+'alldata3.csv')
...
def arimaconcat():
    ...
    weekday = pd.read_csv(path+"week.csv")
    alldata = pd.concat([timedata, weekday], axis=1)
    pd.DataFrame(alldata).to_csv(path+"trafficdata/alldata2.csv", index=None)
    ...
    data22 = pd.read_csv(path + 'allnove&dec.csv')
    df28 = pd.DataFrame(data22)
    df28['Sdate'] = pd.to_datetime(df28['Sdate'])
    df28.sort_values('Sdate', inplace=True)
    pd.DataFrame(df28).to_csv(path + 'allnove&dec1.csv', index=None)
    ...
    dataset2 = pd.read_csv(path + 'date&hours.csv')
    dataset3 = pd.concat([dataset, dataset2], axis=1)
    pd.DataFrame(dataset3).to_csv(path + "Arimavalidation.csv", index=None)

    dataset4 = pd.read_csv(path + "Arimavalidation.csv")
    week = []
    for i in range(len(dataset4)):
        week1 = datetime.strptime(str(dataset4['date'][i]), "%Y-%m-%d").weekday()
        week.append(week1)
    ...
    weekday = pd.read_csv(path + "week.csv")
    alldata4 = pd.concat([dataset4, weekday], axis=1)
    pd.DataFrame(alldata4).to_csv(path + "Arimavalidation1.csv", index=None)

    dataset4 = pd.read_csv(path + "Arimavalidation1.csv")
    df = pd.DataFrame(dataset4)
    vdata = df.loc[df['date'].isin(['2015-12-05', '2015-12-19',
                                    '2016-11-19', '2016-11-27', '2016-12-11', '2016-12-26',
                                    '2016-12-31', '2017-11-18', '2017-11-25', '2017-12-10', '2017-12-13',
                                    '2017-12-26', '2017-12-30'
                                    ])]
    pd.DataFrame(vdata).to_csv(path + "Arimavalidation2.csv", index=None)
...
def Arimamatches():
    if request.method=='POST':
        ...
        times0 = pd.read_csv(path+'alldata2.csv')
        df = pd.DataFrame(times0)
        df['Sdate'] = pd.to_datetime(df['Sdate'])
        df.sort_values('Sdate', inplace=True)
        df1 = df[df['LaneDescription'] == 'NB_OS']
        pd.DataFrame(df1).to_csv(path+'alldata3.csv', index=None)
        ...
        dataset4=pd.read_csv(path + "Arimavalidation1.csv")
        df=pd.DataFrame(dataset4)
        vdata = df.loc[df['date'].isin(['2015-12-05', '2015-12-19', '2016-11-19',
                                         '2016-11-27', '2016-12-11', '2016-12-26',
                                        '2016-12-31', '2017-11-18', '2017-11-25', '2017-12-10', '2017-12-13',
                                        '2017-12-26', '2017-12-30'])]
...
def Arimamatches2():
    ...
    if request.method == 'POST':
        ...
        r, m = main(int(hour), date, list1,total)
        result.append(r)
        mse.append(m)
